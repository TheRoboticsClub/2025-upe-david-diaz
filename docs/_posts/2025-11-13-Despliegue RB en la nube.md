Una vez tenemos claro el funcionamiento de RoboticsBackend, vamos a subirlo a
comparar 2 de las nubes más famosas para ejecutar contenedores en la nube, como
son Google Cloud y AWS. Para ello se realiza una estimación de costes mensuales,
dependiendo de la nube y la configuración elegida.

## Despliegue de Robotics-Backend en Google Cloud con Google Compute Engine
